...
| rainbond.gateway.jwt-consumer-api | APISIX JWT consumer API and managed route compatibility | active | regression | api/controller/apigateway.Struct Gateway JWT consumer endpoints | api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayHTTPRouteRequestBackwardCompatibility<br>api/controller/apigateway/api_gateway_consumer_test.go::TestPreserveManagedJWTHTTPRouteLabelBeforeCreate<br>api/controller/apigateway/api_gateway_consumer_test.go::TestManagedJWTHTTPRouteRequest<br>api/controller/apigateway/api_gateway_consumer_test.go::TestManagedJWTHTTPRouteResponse<br>api/controller/apigateway/api_gateway_consumer_test.go::TestPreserveLegacyManagedJWTHTTPRouteDoesNotAlterUnmarkedRoute<br>api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayHTTPRouteValidationRejectsEmptyMatch<br>api/controller/apigateway/api_gateway_consumer_test.go::TestCreateHTTPAPIRouteRejectsEmptyHostsAndPaths<br>api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayHTTPRouteResponsesSkipMissingHTTP<br>api/controller/apigateway/api_gateway_consumer_test.go::TestReplaceGatewayHTTPRouteRuleHandlesMissingHTTP<br>api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayJWTConsumerErrorStatus<br>api/controller/apigateway/api_gateway_consumer_test.go::TestCreateGatewayJWTConsumerErrorDoesNotExposeCredential<br>api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayJWTConsumerControllersForwardRequests<br>api/api_routers/gateway/gateway_test.go::TestGatewayConsumerRoutes |
| rainbond.gateway.jwt-consumer-management | Managed APISIX JWT consumer lifecycle | active | regression | api/handler.GatewayAction JWT consumer lifecycle | api/handler/gateway_jwt_consumer_test.go::TestValidateGatewayJWTConsumerCredential<br>api/handler/gateway_jwt_consumer_test.go::TestBuildManagedJWTPlugins<br>api/handler/gateway_jwt_consumer_test.go::TestManagedJWTAuthenticationFromRoute<br>api/handler/gateway_jwt_consumer_test.go::TestGatewayActionCreateJWTConsumer<br>api/handler/gateway_jwt_consumer_test.go::TestGatewayActionCreateJWTConsumerRollsBackSecret<br>api/handler/gateway_jwt_consumer_test.go::TestGatewayActionCreateJWTConsumerRollbackIgnoresPreexistingConsumerReference<br>api/handler/gateway_jwt_consumer_test.go::TestGatewayActionListJWTConsumersDoesNotExposeCredentials<br>api/handler/gateway_jwt_consumer_test.go::TestGatewayActionRotateJWTConsumer<br>api/handler/gateway_jwt_consumer_test.go::TestGatewayActionDeleteJWTConsumerChecksBindings<br>api/handler/gateway_jwt_consumer_test.go::TestGatewayActionConfigureManagedJWTConsumer<br>api/handler/gateway_jwt_consumer_test.go::TestGatewayActionConfigureManagedJWTConsumerRequiresUsableJWTSource<br>api/handler/gateway_jwt_consumer_test.go::TestGatewayActionConfigureManagedJWTAuthValidatesPluginConfig |
...
### APISIX JWT consumer API and managed route compatibility

- Capability ID: `rainbond.gateway.jwt-consumer-api`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `view_endpoint`
- 业务入口: `api/controller/apigateway.Struct Gateway JWT consumer endpoints`
- 代码路径: `api/controller/apigateway/api_gateway_consumer.go`, `api/controller/apigateway/api_gateway_route.go`, `api/api_routers/gateway/gateway.go`
- 测试路径: `api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayHTTPRouteRequestBackwardCompatibility`, `api/controller/apigateway/api_gateway_consumer_test.go::TestPreserveManagedJWTHTTPRouteLabelBeforeCreate`, `api/controller/apigateway/api_gateway_consumer_test.go::TestManagedJWTHTTPRouteRequest`, `api/controller/apigateway/api_gateway_consumer_test.go::TestManagedJWTHTTPRouteResponse`, `api/controller/apigateway/api_gateway_consumer_test.go::TestPreserveLegacyManagedJWTHTTPRouteDoesNotAlterUnmarkedRoute`, `api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayHTTPRouteValidationRejectsEmptyMatch`, `api/controller/apigateway/api_gateway_consumer_test.go::TestCreateHTTPAPIRouteRejectsEmptyHostsAndPaths`, `api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayHTTPRouteResponsesSkipMissingHTTP`, `api/controller/apigateway/api_gateway_consumer_test.go::TestReplaceGatewayHTTPRouteRuleHandlesMissingHTTP`, `api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayJWTConsumerErrorStatus`, `api/controller/apigateway/api_gateway_consumer_test.go::TestCreateGatewayJWTConsumerErrorDoesNotExposeCredential`, `api/controller/apigateway/api_gateway_consumer_test.go::TestGatewayJWTConsumerControllersForwardRequests`, `api/api_routers/gateway/gateway_test.go::TestGatewayConsumerRoutes`

### Managed APISIX JWT consumer lifecycle

- Capability ID: `rainbond.gateway.jwt-consumer-management`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `workflow`
- 业务入口: `api/handler.GatewayAction JWT consumer lifecycle`
- 代码路径: `api/model/api_gateway_model.go`, `api/handler/gateway_handler.go`, `api/handler/gateway_jwt_consumer.go`
- 测试路径: `api/handler/gateway_jwt_consumer_test.go::TestValidateGatewayJWTConsumerCredential`, `api/handler/gateway_jwt_consumer_test.go::TestBuildManagedJWTPlugins`, `api/handler/gateway_jwt_consumer_test.go::TestManagedJWTAuthenticationFromRoute`, `api/handler/gateway_jwt_consumer_test.go::TestGatewayActionCreateJWTConsumer`, `api/handler/gateway_jwt_consumer_test.go::TestGatewayActionCreateJWTConsumerRollsBackSecret`, `api/handler/gateway_jwt_consumer_test.go::TestGatewayActionCreateJWTConsumerRollbackIgnoresPreexistingConsumerReference`, `api/handler/gateway_jwt_consumer_test.go::TestGatewayActionListJWTConsumersDoesNotExposeCredentials`, `api/handler/gateway_jwt_consumer_test.go::TestGatewayActionRotateJWTConsumer`, `api/handler/gateway_jwt_consumer_test.go::TestGatewayActionDeleteJWTConsumerChecksBindings`, `api/handler/gateway_jwt_consumer_test.go::TestGatewayActionConfigureManagedJWTConsumer`, `api/handler/gateway_jwt_consumer_test.go::TestGatewayActionConfigureManagedJWTConsumerRequiresUsableJWTSource`, `api/handler/gateway_jwt_consumer_test.go::TestGatewayActionConfigureManagedJWTAuthValidatesPluginConfig`
...
- Capability ID: `rainbond.vm-export.root-disk-url`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `handler_method`
...
- Capability ID: `rainbond.vm-hotplug.data-volume-capacity-gi`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `package_function`
- 业务入口: `api/handler.buildVMHotplugDataVolumeObject`
- 代码路径: `api/handler/service_vm_hotplug.go`
- 测试路径: `api/handler/service_vm_hotplug_test.go::TestBuildVMHotplugDataVolumeObjectUsesGiCapacity`
...
- Capability ID: `rainbond.vm-import.registry-datavolume`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `workflow`
...
- Capability ID: `rainbond.vm-live-update.capability-requires-installer-media-removal`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `handler_method`
- 业务入口: `api/handler.ServiceAction.GetVMLiveUpdateCapability`
- 代码路径: `api/handler/service_vm_live_update.go`
- 测试路径: `api/handler/service_vm_live_update_test.go::TestGetVMLiveUpdateCapabilityRejectsWhenInstallerMediaStillAttached`
...
- Capability ID: `rainbond.vm-live-update.installer-media-removal-required`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `handler_method`
- 业务入口: `api/handler.ServiceAction.applyVMLiveUpdateIfPossible`
- 代码路径: `api/handler/service_vm_live_update.go`
- 测试路径: `api/handler/service_vm_live_update_test.go::TestServiceVerticalVMLiveUpdateRejectsWhenInstallerMediaStillAttached`

### 拒绝等于 maxGuest 的虚拟机内存热更新目标

- Capability ID: `rainbond.vm-live-update.memory-target-below-max-guest`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `handler_method`
- 业务入口: `api/handler.ServiceAction.applyVMLiveUpdateIfPossible`
...
- Capability ID: `rainbond.vm-live-update.running-cpu-shrink-rejected`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `handler_method`
- 业务入口: `api/handler.ServiceAction.applyVMLiveUpdateIfPossible`
- 代码路径: `api/handler/service_vm_live_update.go`
- 测试路径: `api/handler/service_vm_live_update_test.go::TestServiceVerticalVMLiveUpdateRejectsRunningVMCPUShrink`
...
- Capability ID: `rainbond.vm-pods.cleanup-completed-virt-launcher`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `handler_method`
- 业务入口: `api/handler.ServiceAction.GetPods`
- 代码路径: `api/handler/service_vm_pod_cleanup.go`
- 测试路径: `api/handler/service_vm_pod_cleanup_test.go::TestGetPodsCleansUpCompletedVMLauncherPodsAfterHotUpdate`
...
- Capability ID: `rainbond.vm-probe-attribute-syncs-spec`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `package_function`
- 业务入口: `api/handler.isVMRuntimeSpecAttribute`
- 代码路径: `api/handler/k8s_attribute.go`
- 测试路径: `api/handler/k8s_attribute_vm_runtime_test.go::TestIsVMRuntimeSpecAttributeIncludesProbeAttributes`

### VM probe changes sync VirtualMachine spec

- Capability ID: `rainbond.vm-probe-change-syncs-spec`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `handler_method`
- 业务入口: `api/handler.ServiceAction.ServiceProbe`
- 代码路径: `api/handler/service.go`
- 测试路径: `api/handler/service_vm_resource_sync_test.go::TestServiceProbeSyncsVirtualMachineSpecWhenVMProbeChanges`

### 将导出的虚拟机磁盘构建为 HTTP 制品镜像

- Capability ID: `rainbond.vm-publish.http-artifact-image-build`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `workflow`
- 业务入口: `builder/exector.BuildFromVM`
- 代码路径: `api/handler/share/service_share.go`, `builder/exector/build_from_vm.go`, `builder/sources/image.go`, `builder/sourceutil/remote_http_client.go`
- 测试路径: `api/handler/share/service_share_test.go::TestServiceShareVMImageSourceSkipsDeliveredPathReferenceValidation`, `builder/exector/build_from_vm_test.go::TestRenderVMDockerfileUsesHTTPArtifactForGzipRawExport`, `builder/exector/build_from_vm_test.go::TestDownloadFileUsesVMExportTokenHeader`, `builder/exector/build_from_vm_test.go::TestDownloadFileOverwritesExistingPartialFile`, `builder/exector/build_from_vm_test.go::TestVMRemoteImageSourceDirUsesEventID`, `builder/exector/build_from_vm_test.go::TestMyDownloaderLogsUnknownSizeProgress`, `builder/exector/share_image_test.go::TestNewImageShareItemCapturesVMImageSource`, `builder/sources/image_test.go::TestBuildKitImageOutputUsesUncompressedLayersForVMBuild`, `builder/sourceutil/remote_http_client_test.go::TestNewRemotePackageHTTPClientSkipsTLSVerifyForVMExportService`
...
- Capability ID: `rainbond.vm-runtime.disk-layout-attr-triggers-spec-sync`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `package_function`
- 业务入口: `api/handler.isVMRuntimeSpecAttribute`
...
- 测试路径: `api/handler/service_vm_status_test.go::TestResolveVMRestoreStatusIncludesDataVolumeProgress`, `api/handler/service_vm_status_test.go::TestResolveVMRestoreStatusMarksAllDataVolumesSucceeded`, `api/handler/service_vm_status_test.go::TestResolveVMDataVolumeRestoreIgnoresInitialBlankDataVolumes`

### VM restore status is limited to artifact imports
...
- 代码路径: `api/handler/service.go`
- 测试路径: `api/handler/service_vm_status_test.go::TestResolveVMTransitionStatusReturnsStartingForDataVolumeImportWithoutRestoreContext`, `api/handler/service_vm_status_test.go::TestResolveVMServiceRuntimeStatusReturnsRestoringWhenArtifactDataVolumeImportsBeforeVMIExists`, `api/handler/service_vm_status_test.go::TestResolveVMServiceRuntimeStatusReturnsStartingForInitialBlankDataVolume`, `api/handler/service_vm_status_test.go::TestResolveVMServiceRuntimeStatusReturnsStartingForInitialHTTPDataVolume`, `api/handler/service_vm_status_test.go::TestResolveVMTransitionStatusReturnsAbnormalForDataVolumeError`
...
- Capability ID: `rainbond.worker.appm.vm-memory-hotplug-headroom`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `package_function`
- 业务入口: `worker/appm/conversion.buildStandardVMMemory`
...
### Parse component cmd and args attributes as YAML arrays

- Capability ID: `rainbond.worker.conversion.cmd-args-yaml`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `workflow`
