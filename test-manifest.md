...
### 将导出的虚拟机磁盘构建为 qcow2 发布镜像

- Capability ID: `rainbond.vm-publish.qcow2-image-build`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `workflow`
