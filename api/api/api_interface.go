...
type KubeBlocksInterface interface {
	...
	CreateBackupRepo(w http.ResponseWriter, r *http.Request)
	UpdateBackupRepo(w http.ResponseWriter, r *http.Request)
	DeleteBackupRepo(w http.ResponseWriter, r *http.Request)
