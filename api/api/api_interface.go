...
type TenantInterface interface {
	...
	TenantStartService(w http.ResponseWriter, r *http.Request)
}
...
type ApplicationInterface interface {
	...
	AddGrayRelease(w http.ResponseWriter, r *http.Request)
	UpdateGrayRelease(w http.ResponseWriter, r *http.Request)
	GetGrayRelease(w http.ResponseWriter, r *http.Request)
	OperateGrayRelease(w http.ResponseWriter, r *http.Request)
