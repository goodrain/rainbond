...
func (v *VMBuildItem) vmBuild(sourcePath string) error {
	...
	err = sources.ImageBuild("", v.Arch, sourcePath, "", "", utils.GetenvDefault("RBD_NAMESPACE", constants.Namespace), v.ServiceID, v.DeployVersion, v.Logger, "vm-build", imageName, v.BuildKitImage, v.BuildKitArgs, v.BuildKitCache, v.kubeClient, false)
	if err != nil {
