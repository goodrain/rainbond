...
func AddStorageFlags(fs *pflag.FlagSet, sc *StorageConfig) {
	...
	fs.StringVar(&sc.S3AccessKeyID, "s3-access-key-id", "minioadmin", "s3 accessKeyID")
	fs.StringVar(&sc.S3SecretAccessKey, "s3-secret-access-key", "minioadmin", "s3 secretAccessKey")
}
