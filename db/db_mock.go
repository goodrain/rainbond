...
// IPPortDao mocks base method
func (m *MockManager) IPPortDao() dao.IPPortDao {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IPPortDao")
	ret0, _ := ret[0].(dao.IPPortDao)
	return ret0
}

// IPPortDao indicates an expected call of IPPortDao
func (mr *MockManagerMockRecorder) IPPortDao() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IPPortDao", reflect.TypeOf((*MockManager)(nil).IPPortDao))
}

// IPPortDaoTransactions mocks base method
func (m *MockManager) IPPortDaoTransactions(db *gorm.DB) dao.IPPortDao {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IPPortDaoTransactions", db)
	ret0, _ := ret[0].(dao.IPPortDao)
	return ret0
}

// IPPortDaoTransactions indicates an expected call of IPPortDaoTransactions
func (mr *MockManagerMockRecorder) IPPortDaoTransactions(db interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IPPortDaoTransactions", reflect.TypeOf((*MockManager)(nil).IPPortDaoTransactions), db)
}

// IPPoolDao mocks base method
func (m *MockManager) IPPoolDao() dao.IPPoolDao {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IPPoolDao")
	ret0, _ := ret[0].(dao.IPPoolDao)
	return ret0
}

// IPPoolDao indicates an expected call of IPPoolDao
func (mr *MockManagerMockRecorder) IPPoolDao() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IPPoolDao", reflect.TypeOf((*MockManager)(nil).IPPoolDao))
}
