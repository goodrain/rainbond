...
import (
	...
	elasticdao "github.com/goodrain/rainbond/db/elastic/dao"
...
func (m *Manager) TenantServiceInspectionDao() dao.TenantServiceCodeInspection {
	return &mysqldao.TenantServiceInspectionDaoImpl{
		DB: m.db,
	}
}

// TenantServiceInspectionDaoTransactions -
func (m *Manager) TenantServiceInspectionDaoTransactions(db *gorm.DB) dao.TenantServiceCodeInspection {
	return &mysqldao.TenantServiceInspectionDaoImpl{
		DB: db,
	}
}
...
func (m *Manager) ServiceEventDao() dao.EventDao {
	return &elasticdao.EventDaoImpl{}
}
