...
func (FilterChainMatch_ConnectionSourceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_listener_e542154e9b32cb0a, []int{1, 0}
}
...
func (*Filter) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_e542154e9b32cb0a, []int{0}
}
...
func (*FilterChainMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_e542154e9b32cb0a, []int{1}
}
...
func (*FilterChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_e542154e9b32cb0a, []int{2}
}
...
func (*ListenerFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_e542154e9b32cb0a, []int{3}
}
...
func init() {
	proto.RegisterFile("envoy/api/v2/listener/listener.proto", fileDescriptor_listener_e542154e9b32cb0a)
}

var fileDescriptor_listener_e542154e9b32cb0a = []byte{
	// 877 bytes of a gzipped FileDescriptorProto
	,
}
