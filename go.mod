...
require (
	...
	github.com/goodrain/rainbond-oam v0.0.0-20260616102325-d00568abe287
...
replace (
	...
	github.com/lyft/protoc-gen-validate => github.com/envoyproxy/protoc-gen-validate v0.9.1
	...
	github.com/ncabatoff/process-exporter => ./third_party/process-exporter
	...
	helm.sh/helm/v3 => helm.sh/helm/v3 v3.16.0
