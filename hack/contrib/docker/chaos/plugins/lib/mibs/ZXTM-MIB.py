# PySNMP SMI module. Autogenerated from smidump -f python ZXTM-MIB
# by libsmi2pysnmp-0.1.3 at Thu May 14 15:57:23 2015,
...
( Bits, Counter32, Gauge32, Integer32, Integer32, IpAddress, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, TimeTicks, enterprises, ) = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Gauge32", "Integer32", "Integer32", "IpAddress", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "TimeTicks", "enterprises")
...
steelheadEntry = MibTableRow((1, 3, 6, 1, 4, 1, 7146, 1, 2, 31, 2, 1)).setIndexNames((0, "ZXTM-MIB", "steelheadName"))
...
testaction = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 1)).setObjects(*(("ZXTM-MIB", "actionName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
customevent = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 9)).setObjects(*(("ZXTM-MIB", "customEventName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
nodeworking = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 69)).setObjects(*(("ZXTM-MIB", "perPoolNodeNodePort"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "perPoolNodePoolName"), ("ZXTM-MIB", "perPoolNodeNodeAddressType"), ("ZXTM-MIB", "perPoolNodeNodeAddress"), ) )
if mibBuilder.loadTexts: nodeworking.setDescription("Node is working again")
nostarttls = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 70)).setObjects(*(("ZXTM-MIB", "perPoolNodeNodePort"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "perPoolNodePoolName"), ("ZXTM-MIB", "perPoolNodeNodeAddressType"), ("ZXTM-MIB", "perPoolNodeNodeAddress"), ) )
if mibBuilder.loadTexts: nostarttls.setDescription("Node doesn't provide STARTTLS support")
nodefail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 71)).setObjects(*(("ZXTM-MIB", "perPoolNodeNodePort"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "perPoolNodePoolName"), ("ZXTM-MIB", "perPoolNodeNodeAddressType"), ("ZXTM-MIB", "perPoolNodeNodeAddress"), ) )
if mibBuilder.loadTexts: nodefail.setDescription("Node has failed")
starttlsinvalid = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 72)).setObjects(*(("ZXTM-MIB", "perPoolNodeNodePort"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "perPoolNodePoolName"), ("ZXTM-MIB", "perPoolNodeNodeAddressType"), ("ZXTM-MIB", "perPoolNodeNodeAddress"), ) )
if mibBuilder.loadTexts: starttlsinvalid.setDescription("Node returned invalid STARTTLS response")
ehloinvalid = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 73)).setObjects(*(("ZXTM-MIB", "perPoolNodeNodePort"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "perPoolNodePoolName"), ("ZXTM-MIB", "perPoolNodeNodeAddressType"), ("ZXTM-MIB", "perPoolNodeNodeAddress"), ) )
...
slmrecoveredwarn = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 83)).setObjects(*(("ZXTM-MIB", "serviceLevelName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: slmrecoveredwarn.setDescription("SLM has recovered")
slmrecoveredserious = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 84)).setObjects(*(("ZXTM-MIB", "serviceLevelName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: slmrecoveredserious.setDescription("SLM has risen above the serious threshold")
slmfallenbelowwarn = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 85)).setObjects(*(("ZXTM-MIB", "serviceLevelName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: slmfallenbelowwarn.setDescription("SLM has fallen below warning threshold")
slmfallenbelowserious = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 86)).setObjects(*(("ZXTM-MIB", "serviceLevelName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
vsstart = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 88)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: vsstart.setDescription("Virtual server started")
vsstop = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 89)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: vsstop.setDescription("Virtual server stopped")
privkeyok = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 90)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: privkeyok.setDescription("Private key now OK (hardware available)")
ssldrop = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 91)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: ssldrop.setDescription("Request(s) received while SSL configuration invalid, connection closed")
vslogwritefail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 92)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: vslogwritefail.setDescription("Failed to write log file for virtual server")
vssslcertexpired = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 93)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: vssslcertexpired.setDescription("Public SSL certificate expired")
vssslcerttoexpire = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 94)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: vssslcerttoexpire.setDescription("Public SSL certificate will expire within seven days")
vscacertexpired = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 95)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: vscacertexpired.setDescription("Certificate Authority certificate expired")
vscacerttoexpire = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 96)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
connerror = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 104)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: connerror.setDescription("A protocol error has occurred")
connfail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 105)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: connfail.setDescription("A socket connection failure has occurred")
badcontentlen = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 106)).setObjects(*(("ZXTM-MIB", "perPoolNodeNodePort"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "perPoolNodePoolName"), ("ZXTM-MIB", "perPoolNodeNodeAddressType"), ("ZXTM-MIB", "perPoolNodeNodeAddress"), ) )
...
logfiledeleted = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 115)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
license_graceperiodexpired = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 116)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-graceperiodexpired")
if mibBuilder.loadTexts: license_graceperiodexpired.setDescription("Unable to authorize license key")
license_authorized = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 117)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-authorized")
if mibBuilder.loadTexts: license_authorized.setDescription("License key authorized")
license_rejected_authorized = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 118)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-rejected-authorized")
...
license_rejected_unauthorized = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 119)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-rejected-unauthorized")
...
license_timedout_authorized = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 120)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-timedout-authorized")
...
license_timedout_unauthorized = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 121)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-timedout-unauthorized")
...
license_unauthorized = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 122)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-unauthorized")
...
locationmonitorok = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 152)).setObjects(*(("ZXTM-MIB", "locationName"), ("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: locationmonitorok.setDescription("A monitor has indicated this location is now working")
locationmonitorfail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 153)).setObjects(*(("ZXTM-MIB", "locationName"), ("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: locationmonitorfail.setDescription("A monitor has detected a failure in this location")
locationok = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 154)).setObjects(*(("ZXTM-MIB", "locationName"), ("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: locationok.setDescription("Location is now working for GLB Service")
locationfail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 155)).setObjects(*(("ZXTM-MIB", "locationName"), ("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: locationfail.setDescription("Location has failed for GLB Service")
locationsoapok = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 156)).setObjects(*(("ZXTM-MIB", "locationName"), ("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: locationsoapok.setDescription("An external SOAP agent indicates this location is now working")
locationsoapfail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 157)).setObjects(*(("ZXTM-MIB", "locationName"), ("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
glbnewmaster = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 160)).setObjects(*(("ZXTM-MIB", "locationName"), ("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: glbnewmaster.setDescription("A location has been set as active for a GLB service")
glblogwritefail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 161)).setObjects(*(("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: glblogwritefail.setDescription("Failed to write log file for GLB service")
glbfailalter = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 162)).setObjects(*(("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
locmovemachine = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 173)).setObjects(*(("ZXTM-MIB", "locationName"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "zxtmName"), ) )
if mibBuilder.loadTexts: locmovemachine.setDescription("Machine now in location")
locempty = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 174)).setObjects(*(("ZXTM-MIB", "locationName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
zxtmhighload = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 189)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
glbservicedied = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 190)).setObjects(*(("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: glbservicedied.setDescription("GLB Service has no working locations")
glbserviceok = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 191)).setObjects(*(("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: glbserviceok.setDescription("GLB Service has recovered")
license_rejected_unauthorized_ts = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 192)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-rejected-unauthorized-ts")
if mibBuilder.loadTexts: license_rejected_unauthorized_ts.setDescription("License key rejected from authorization code")
license_authorized_ts = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 193)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-authorized-ts")
if mibBuilder.loadTexts: license_authorized_ts.setDescription("License key authorized by authorization code")
license_rejected_authorized_ts = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 194)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-rejected-authorized-ts")
...
license_timedout_authorized_ts = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 195)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-timedout-authorized-ts")
...
license_timedout_unauthorized_ts = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 196)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-timedout-unauthorized-ts")
if mibBuilder.loadTexts: license_timedout_unauthorized_ts.setDescription("Unable to run authorization code to completion")
license_graceperiodexpired_ts = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 197)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-graceperiodexpired-ts")
if mibBuilder.loadTexts: license_graceperiodexpired_ts.setDescription("Unable to authorize license key")
flipperraiseremotedropped = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 198)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
sslrehandshakemininterval = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 199)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
sslhandshakemsgsizelimit = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 200)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
sslcrltoobig = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 201)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
numpools_exceeded = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 202)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) ).setLabel("numpools-exceeded")
if mibBuilder.loadTexts: numpools_exceeded.setDescription("Total number of pools exceeded the maximum limit")
numlocations_exceeded = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 203)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) ).setLabel("numlocations-exceeded")
if mibBuilder.loadTexts: numlocations_exceeded.setDescription("Total number of locations exceeded the maximum limit")
numtipg_exceeded = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 204)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) ).setLabel("numtipg-exceeded")
if mibBuilder.loadTexts: numtipg_exceeded.setDescription("Total number of traffic IP group exceeded the maximum allowed")
numnodes_exceeded = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 205)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) ).setLabel("numnodes-exceeded")
...
ec2nosecondaryprivateip = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 206)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
ec2vpceipassocerr = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 207)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
ec2vpciderr = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 208)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: ec2vpciderr.setDescription("Problem occurred while getting VPCID")
license_explicitlydisabled_ts = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 209)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "licensekeyName"), ) ).setLabel("license-explicitlydisabled-ts")
...
rulesinvalidrequestbody = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 217)).setObjects(*(("ZXTM-MIB", "virtualserverName"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
if mibBuilder.loadTexts: rulesinvalidrequestbody.setDescription("Client sent invalid HTTP request body")
serviceruleabort = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 218)).setObjects(*(("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
if mibBuilder.loadTexts: serviceruleabort.setDescription("GLB service rule aborted during execution")
servicerulelocunknown = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 219)).setObjects(*(("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
if mibBuilder.loadTexts: servicerulelocunknown.setDescription("GLB service rule specified an unknown location")
servicerulelocnotconfigured = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 220)).setObjects(*(("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
...
servicerulelocdead = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 221)).setObjects(*(("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
...
aptimizeuseunknownprofile = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 222)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
if mibBuilder.loadTexts: aptimizeuseunknownprofile.setDescription("Rule selected an unknown Aptimizer profile")
aptimizedisabled = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 223)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
if mibBuilder.loadTexts: aptimizedisabled.setDescription("Rule attempted to use Aptimizer but it is not enabled")
aptimizeuseunknownscope = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 224)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
if mibBuilder.loadTexts: aptimizeuseunknownscope.setDescription("Rule selected an unknown Aptimizer scope")
childcommsfail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 225)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: childcommsfail.setDescription("There was an error communicating with a child process")
datalocalstorefull = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 228)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
if mibBuilder.loadTexts: datalocalstorefull.setDescription("data.local.set() has run out of space")
fipsfailinit = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 229)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: fipsfailinit.setDescription("FIPS 140-2 cryptographic module initialization failed")
fipsfailops = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 230)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: fipsfailops.setDescription("FIPS 140-2 cryptographic module operations failed")
rebootrequired = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 233)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: rebootrequired.setDescription("Machine must be rebooted to apply configuration changes")
ocspstaplingfail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 234)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: ocspstaplingfail.setDescription("OCSP request (for OCSP stapling) failed")
ocspstaplingnomem = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 235)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: ocspstaplingnomem.setDescription("Insufficient memory for OCSP stapling")
appliance = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 236)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: appliance.setDescription("Appliance notification")
pingsendfail = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 237)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: pingsendfail.setDescription("Failed to send ping packets")
autonodenopublicip = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 238)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "poolName"), ) )
if mibBuilder.loadTexts: autonodenopublicip.setDescription("Node has no public IP address")
ocspstaplingrevoked = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 239)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
ocspstaplingunknown = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 240)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
ocspstaplingunrevoked = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 241)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
ruleoverrun = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 242)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "ruleName"), ) )
if mibBuilder.loadTexts: ruleoverrun.setDescription("Rule exceeded execution time warning threshold")
autonoderemoved = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 244)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "poolName"), ) )
if mibBuilder.loadTexts: autonoderemoved.setDescription("A node in an DNS-derived autoscaled pool has been removed")
routingswoperational = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 245)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: routingswoperational.setDescription("Routing software is now operational")
routingswfailurelimitreached = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 246)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
routingswfailed = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 247)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: routingswfailed.setDescription("Routing software had a major failure and will be restarted")
routingswstartfailed = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 248)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: routingswstartfailed.setDescription("Routing software failed to start")
ospfneighborsok = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 253)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: ospfneighborsok.setDescription("All monitored OSPF neighbors are peered")
ospfneighborsdegraded = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 254)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: ospfneighborsdegraded.setDescription("Some of the monitored OSPF neighbors are not peered")
ospfneighborsfailed = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 255)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: ospfneighborsfailed.setDescription("None of the monitored OSPF neighbors are peered")
nameserverunavailable = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 256)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "poolName"), ) )
...
nameserveravailable = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 257)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "poolName"), ) )
...
glbtoomanylocations = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 259)).setObjects(*(("ZXTM-MIB", "glbServiceName"), ("ZXTM-MIB", "fullLogLine"), ) )
...
dnszonevalidate = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 260)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: dnszonevalidate.setDescription("The built-in DNS server has failed to validate a DNS zone file")
dnszonecreaterecord = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 261)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: dnszonecreaterecord.setDescription("The built-in DNS server has failed to create a DNS record")
dnszoneparsechild = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 262)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: dnszoneparsechild.setDescription("The built-in DNS server has failed to parse a DNS zone file in a child process")
dnserroraddzone = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 263)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: dnserroraddzone.setDescription("The built-in DNS server has failed to add a DNS zone")
dnsaddzone = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 264)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ("ZXTM-MIB", "domainName"), ("ZXTM-MIB", "confName"), ) )
if mibBuilder.loadTexts: dnsaddzone.setDescription("The built-in DNS server has successfully added a DNS zone")
dnszoneparse = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 265)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
if mibBuilder.loadTexts: dnszoneparse.setDescription("The built-in DNS server has failed to parse a DNS zone file")
ec2dataretrievalfailed = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 266)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
ec2dataretrievalsuccessful = NotificationType((1, 3, 6, 1, 4, 1, 7146, 1, 2, 15, 0, 267)).setObjects(*(("ZXTM-MIB", "fullLogLine"), ) )
...
mibBuilder.exportSymbols("ZXTM-MIB", dnsaddzone=dnsaddzone, dnszoneparse=dnszoneparse, ec2dataretrievalfailed=ec2dataretrievalfailed, ec2dataretrievalsuccessful=ec2dataretrievalsuccessful, dnszonedelete=dnszonedelete, dnserrordeletezone=dnserrordeletezone)
